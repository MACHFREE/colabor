 ...
 */
class modColabor extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 140189; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'colabor';
        ...
        $this->description = "Modulo de seguimiento colaborativo";
        // Used only if file README.md and README-LL.md not found.
        $this->descriptionlong = "Modulo de seguimiento colaborativo entre usuario internos";
        $this->editor_name = '<b>Machfree</b>';
        ...
        $this->module_parts = array(
            ...
            'css' => array(
                   //'/colabor/css/colabor.css',
            ),
            // Set this to relative path of js file if module must load a js on all pages
            'js' => array(
                  '/colabor/js/colabor.js',
            ),
            // Set here all hooks context managed by module. To find available hook context, make a "grep -r '>initHooks(' *" on source code. You can also set hook context to 'all'
            'hooks' => array('thirdpartycard','thirdpartysupplier','thirdpartycomm','productcard', 'propalcard', 'supplier_proposalcard', 'ordercard','ordersuppliercard','invoicecard', 'invoicesuppliercard','projectcard','printFieldListWhere','sertegacard','waranticard','preopportunitycard'),
        ...
        $this->config_page_url = array("setup.php@colabor");
        // Dependencies
        ...
        $this->langfiles = array("colabor@colabor");
        ...
        /* Example:*/
        $this->dictionaries=array(
            'langs'=>'colabor@colabor',
            // List of tables we want to see into dictonnary editor
            'tabname'=>array(MAIN_DB_PREFIX."colabor_type_annotation"),
            // Label of tables
            'tablib'=>array("Tipo de anotaciones"),
            // Request to select fields
            'tabsql'=>array('SELECT f.rowid as rowid, f.code, f.label, f.active FROM '.MAIN_DB_PREFIX.'colabor_type_annotation as f'),
            // Sort order
            ...
            'tabcond'=>array($conf->colabor->enabled)
        );
        ...
        // $this->boxes = array(
        //      0 => array(
        //          'file' => 'colabor_box_project.php@colabor',
        //          // 'note' => 'Widget provided by Colabor',
        //          'enabledbydefaulton' => 'Home',
        //      ),
        //     1 => array(
        //          'file' => 'colabor_box_project_2.php@colabor',
        //          // 'note' => 'Widget provided by Colabor',
        //          'enabledbydefaulton' => 'Home',
        //      ),
        //     2 => array(
        //          'file' => 'colabor_box_project_3.php@colabor',
        //          // 'note' => 'Widget provided by Colabor',
        //          'enabledbydefaulton' => 'Home',
        //      ),
        ...
        $this->rights[$r][0] = 1401891; // Permission id (must not be already used)
        $this->rights[$r][1] = 'Leer todas las acciones'; // Permission label
        $this->rights[$r][2] = 'r';
        $this->rights[$r][3] = 1;
        ...
        $r++;
        $this->rights[$r][0] = 1401892; // Permission id (must not be already used)
        $this->rights[$r][1] = 'Crear las acciones'; // Permission label
        $this->rights[$r][2] = 'w';
        $this->rights[$r][3] = 0;
        ...
        $r++;
        $this->rights[$r][0] = 1401893; // Permission id (must not be already used)
        $this->rights[$r][1] = 'Editar las acciones'; // Permission label
        $this->rights[$r][2] = 'e';
        $this->rights[$r][3] = 0;
        $this->rights[$r][4] = 'edit'; // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        // $this->rights[$r][5] = 'edit'; // In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
        $r++;
        $this->rights[$r][0] = 1401894; // Permission id (must not be already used)
        $this->rights[$r][1] = 'Eliminar las acciones'; // Permission label
        $this->rights[$r][2] = 'd';
        $this->rights[$r][3] = 0;
    ...
    public function init($options = '')
    {
        ...
        $result = $this->_load_tables('/colabor/sql/');
        ...
        //$extrafields->addExtraField('seguim', "Requiere seguimiento?", 'select', 200, "", 'product',0, 0, "", array('options'=>array('0'=>'No','1'=>'Si')), 1,'', 1, 0, '', '', 'colabo@colabor', '$conf->colabor->enabled');
        //$extrafields->addExtraField('seguim', "Requiere seguimiento?", 'select', 200, "", 'projet',0, 0, "", array('options'=>array('0'=>'No','1'=>'Si')), 1,'', 0, 0, '', '', 'colabo@colabor', '$conf->colabor->enabled');
        //$extrafields->addExtraField('seguim', "Requiere seguimiento?", 'select', 200, "", 'thirdparty',0, 0, "", array('options'=>array('0'=>'No','1'=>'Si')), 1,'', 0, 0, '', '', 'colabo@colabor', '$conf->colabor->enabled');
        ...
        // $result4=$extrafields->addExtraField('Requiere seguimiento?1', "seguim1", 'select',  1,  3, 'Products',   0, 1, '', array('options'=>array('0'=>'No','1'=>'Si')), 1,'', 0, 0, '', '', 'colabo@colabor', '$conf->colabor->enabled');
    ...
    public function remove($options = '')
    {
       ...
       //  $sql = array("DELETE FROM ".MAIN_DB_PREFIX."const WHERE name like '%_colabor' OR name like '%_colabor_%';");
