...
ALTER TABLE llx_colabor ADD INDEX idx_fieldobject (fieldobject);
...
ALTER TABLE `llx_colabor` ADD COLUMN `mentions` LONGTEXT COMMENT 'JSON con menciones guardadas';


ALTER TABLE `llx_colabor` ADD COLUMN `annotation_type` int DEFAULT NULL;